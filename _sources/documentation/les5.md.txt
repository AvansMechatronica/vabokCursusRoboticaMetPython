# Les 5: Programmeren van sensoren
...
while True:
    ...
    time.sleep(0.5)
```
De uitleg van dit Python-programma vind je in de [Licht Sensor Code Uitleg](les5_uitleg_code_licht_sensor.md).
...
while True:
    ...
    time.sleep(1)
```
De uitleg van dit Python-programma vind je in de [Ultrasoon Sensor Code Uitleg](les5_uitleg_code_ultrasoon_sensor.md).
...
De uitleg van dit Python-programma vind je in de [Trackingsensor Code Uitleg](les5_uitleg_code_trackingsensor.md).
